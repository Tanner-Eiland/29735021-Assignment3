...
const question1 = (myNumber) => {
  ...
  const question3 = (myValue) => {
    ...
    if (myValue.toString().length == 10){
        myLang = "JavaScript";}
    else if (myValue.toString().length > 3){
        myLang = "PHP";}
    else{
        myLang = "Python";}
    /////// write your IF statement above this line /////////
  ...
  switch (myNumber) {
      case 1: myFaveFood = "Pizza"; break;
      case 2: myFaveFood = "Hamburger"; break;
      case 3: myFaveFood = "Ice Cream"; break;
      case 4: myFaveFood = "Sushi"; break;
  ...
  //below is a what I used to test the code above
  const testTheCode = (myValue, myNumber, myTemp) => {
      console.log(question1(myNumber));
      console.log(question2(myValue));
      console.log(question3(myValue));
      console.log(question4(myNumber));
      console.log(question5(myTemp));
